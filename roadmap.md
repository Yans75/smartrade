...
- Génération de signaux par LLM (DeepSeek, appelé directement) persistés en base
...
- Obtenir une clé DeepSeek et confirmer l'id exact du modèle à utiliser (`DEEPSEEK_MODEL`) — aucune valeur par défaut n'est codée en dur
