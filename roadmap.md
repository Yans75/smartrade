...
- Génération de signaux par le moteur Jev (TypeSafe AI, `jev-latest`) persistés en base, avec journal de calibration dans `jev_calls`
...
- Premier appel réel à TypeSafe pour valider bout en bout (le réseau de cet environnement de dev bloque api.typesafe.ai ; le client a été validé contre un serveur factice)
